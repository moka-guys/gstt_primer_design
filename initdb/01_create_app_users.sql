...
-- Schema
-- =========================
CREATE SCHEMA IF NOT EXISTS prada_production;
...
-- =========================
CREATE TABLE IF NOT EXISTS prada_production.primers (
...
-- =========================
CREATE TABLE IF NOT EXISTS prada_production.primer_batches (
    ...
    CONSTRAINT fk_primer
        FOREIGN KEY (upi)
        REFERENCES prada_production.primers(upi)
        ON DELETE CASCADE
);
-- =========================
-- Index
...
ON prada_production.primer_batches(upi);